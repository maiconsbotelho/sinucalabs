    ...
    <div className="min-h-screen relative">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center gap-2 mb-1">
              <div className="relative">
                <Trophy className="w-6 h-6 text-retro-cyan animate-pulse-glow" />
                <div className="absolute inset-0 w-6 h-6 text-retro-cyan animate-ping opacity-20">
                  <Trophy className="w-6 h-6" />
                </div>
              </div>
              <h1 className="text-xl font-display font-bold bg-gradient-to-r from-retro-cyan via-retro-pink to-retro-purple bg-clip-text text-transparent">
                SINUCA
              </h1>
              <Zap className="w-5 h-5 text-retro-pink animate-pulse" />
            </div>
            <div className="text-retro-cyan font-display text-sm tracking-[0.3em] mb-0.5">LABS</div>
            <div className="text-retro-light/60 text-xs font-mono tracking-wider">&gt; RANKING SYSTEM v2.0</div>
      ...
      <main className="p-3 max-w-sm mx-auto relative z-10">
        <div className="space-y-4 mt-4">
          ...
          <div className="card-glow p-6 text-center relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <Link href="/nova-partida" className="btn btn-primary w-full text-base py-3">
