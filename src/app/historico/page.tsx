        ...
        <div className="max-w-md mx-auto flex items-center gap-4 relative z-10">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-display font-bold text-retro-cyan">MATCH DATABASE</h1>
        ...
        <div className="space-y-4 mt-6">
          {matches.length === 0 ? (
            <div className="card-glow p-8 text-center">
              ...
              <h3 className="font-display font-bold text-xl text-retro-light mb-3">DATABASE EMPTY</h3>
