          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-1 flex items-center gap-3">
                <div className={`w-10 h-10 rounded-full border-2 flex items-center justify-center font-display text-sm font-bold transition-all duration-300 ${
                  step === 'team1' 
                ...
                {step === 'team1' ? (
                  <>
                    ...
                    <div>
                      ...
                      <div className="font-mono text-sm text-retro-cyan/60">
                        Select 2 warriors [{step === 'team1' ? team1.length : team2.length}/2]
                      </div>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div>
                      ...
                      <div className="font-mono text-sm text-retro-pink/60">
                        Select 2 warriors [{step === 'team1' ? team1.length : team2.length}/2]
                      </div>
                    </div>
                  </>
                    ...
                    <div className="flex items-center justify-between relative z-10">
                      <div className="flex items-center gap-3">
                        <div className={`w-3 h-3 rounded-full ${
                          selected 
                            ? step === 'team1' ? 'bg-retro-cyan' : 'bg-retro-pink'
                            : 'bg-retro-purple/50'
                        } ${selected ? 'animate-pulse' : ''}`}></div>
                ...
                {team1.map((player, index) => (
                  <div key={player.id} className="p-3 bg-retro-cyan/10 rounded-lg border border-retro-cyan/30">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-mono text-xs text-retro-cyan/60">
                        WARRIOR_{index + 1}
                      </span>
                    </div>
                  </div>
                ...
                {team2.map((player, index) => (
                  <div key={player.id} className="p-3 bg-retro-pink/10 rounded-lg border border-retro-pink/30">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-display font-semibold text-retro-pink">
                        {player.name}
                      </span>
                      <span className="font-mono text-xs text-retro-pink/60">
                        WARRIOR_{index + 1}
                      </span>
                    </div>
                  </div>
