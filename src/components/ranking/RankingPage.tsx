      ...
      <main className="p-[10px] max-w-sm mx-auto relative z-10">
        <div className="space-y-4 mt-4">
          ...
          <div className="flex items-center justify-center gap-[10px]">
            <button
              className={`w-[100px] btn btn-secondary text-xs px-3 py-2 border-2 font-mono font-bold transition-all relative
                ${
                  mode === "2x2"
                    ? "border-retro-pink bg-retro-pink text-retro-light animate-pulse-glow-pink"
            ...
            <button
              className={`w-[100px] btn btn-secondary text-xs px-3 py-2 border-2 font-mono font-bold transition-all relative
                ${
                  mode === "1x1"
                    ? "border-retro-cyan bg-retro-cyan text-retro-dark animate-pulse-glow-cyan"
            ...
            <button
              className={`w-[100px] btn btn-secondary text-xs px-2 py-2 border-2 font-mono font-bold transition-all relative
                ${
                  mode === "individual"
                    ? "border-retro-yellow bg-retro-yellow text-retro-dark animate-pulse-glow-yellow"
